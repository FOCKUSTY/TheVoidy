...
export class Telegram extends TelegramService {
  ...
  public send(chatId: number | string, message: string | Format.FmtString): Promise<string> {
    throw new Error("Method not implemented.");
  }

  public sendMessage(chatId: number | string, message: string | string[]): Promise<string> {
    throw new Error("Method not implemented.");
  }
